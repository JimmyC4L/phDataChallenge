...
public class KafkaConfig {
    ...
    public ProducerFactory<String, String> producerFactory(){
        ...
        config.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, BOOTSTRAP_SERVER_ADDRESS);
    ...
    public ConsumerFactory<String, String> consumerFactory(){
        ...
        config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, BOOTSTRAP_SERVER_ADDRESS);
